...
<link rel="stylesheet" rev="stylesheet" href="<?php $this->options->themeUrl('css/sweetTitles.css'); ?>" type="text/css" media="all" />
<script type="text/javascript" src="<?php $this->options->themeUrl('js/sweetTitles.js'); ?>"></script>

<!-- 使用url函数转换相关路径 -->
<link rel="stylesheet" type="text/css" media="all" href="<?php $this->options->themeUrl('style.css'); ?>" />
<link rel="stylesheet" type="text/css" media="all" href="<?php $this->options->themeUrl('zombiles.css'); ?>" />
